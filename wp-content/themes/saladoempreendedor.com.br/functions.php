<?php
	...
	*/
	...
	function theme_scripts() {
		...
		// // Menu Responsive
		wp_enqueue_script('js-menu', get_template_directory_uri() . '/assets/js/menu.min.js', wp_get_theme()->get( 'Version'));

		// // Google Fonts
		wp_enqueue_style( 'google-fonts', 'https://fonts.googleapis.com/css2?family=Roboto+Slab:wght@400;700&display=swap' , array() , wp_get_theme()->get( 'Version'), 'all');
	}
	...
	if(function_exists('acf_add_options_page')){
		acf_add_options_page(array(
			'page_title' => 'Opções de temas',
			'menu_title' => 'Opções de temas',
			'menu_slug'  => 'site_name',
